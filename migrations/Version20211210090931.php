 ...
 */
final class Version20211210090931 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C13D8E604F FOREIGN KEY (parent) REFERENCES category (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
